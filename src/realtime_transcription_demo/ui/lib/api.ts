...
export const transcribe_ws_base_api_transcribe_ws_base_get = async (options?: RequestInit): Promise<{
    data: Record<string, string>;
}> =>{
    const res = await fetch("/api/transcribe/ws-base", {
        ...options,
        method: "GET"
    });
    if (!res.ok) {
...
export const transcribe_ws_base_api_transcribe_ws_base_getKey = ()=>{
    return [
        "/api/transcribe/ws-base"
    ] as const;
};
export function useTranscribe_ws_base_api_transcribe_ws_base_get<TData = {
    data: Record<string, string>;
}>(options?: {
    query?: Omit<UseQueryOptions<{
        data: Record<string, string>;
    ...
    return useQuery({
        queryKey: transcribe_ws_base_api_transcribe_ws_base_getKey(),
        queryFn: ()=>transcribe_ws_base_api_transcribe_ws_base_get(),
        ...options?.query
    });
}
export function useTranscribe_ws_base_api_transcribe_ws_base_getSuspense<TData = {
    data: Record<string, string>;
}>(options?: {
    query?: Omit<UseSuspenseQueryOptions<{
        data: Record<string, string>;
